...
var eyeMaxVertD = 10;
var noseMaxHorizD = 23;
var noseMaxVertD = 10;
var dFromC, eyeDistH, eyeLDistV, eyeRDistV, eyeDistR, mouthStatus = "small";
...
function coverEyes() {
	TweenMax.to(armL, .45, {x: 10, y: 20, rotation: -120, ease: Quad.easeOut});
	TweenMax.to(armR, .45, {x: -10, y: 20, rotation: 120, ease: Quad.easeOut, delay: .1});
}

function uncoverEyes() {
	TweenMax.to(armL, .5, {x:0, y: 0, ease: Quad.easeOut});
	TweenMax.to(armL, .5, {rotation: 0, ease: Quad.easeOut, delay: .1});
	TweenMax.to(armR, .5, {x:0, y: 0, ease: Quad.easeOut});
	TweenMax.to(armR, .5, {rotation: 0, ease: Quad.easeOut, delay: .1});
}
...
/* option für grundposition der flügel */
TweenMax.set(armL, {x: 0, y: 0, rotation: 0, transformOrigin: "top left"});
TweenMax.set(armR, {x: 0, y: 0, rotation: 0, transformOrigin: "top right"});
